<template>
  <form class="hire-professional-content-wrap" @submit.prevent="">
    ...
    <div class="info-col-items  mb-30">
    ...
    <div class="info-col-items flex-inner ">
      <div class="info-col-6x">
      ...
      <div v-if="isEndPeriodShown" class="info-col-6x ml-auto">
        <div class="ml-auto">
          <div class="info-col__title">
            {{ $t("end") }}
          </div>
    ...
    <div class="content-form__item-info">
      <label class="content-form__item-label present-work">
        <input type="checkbox" @change="isEndPeriodShown = !isEndPeriodShown" />
        <span class="content-form__item-check">
          <CheckIcon />
        </span>
        <span class="content-form__item-title">
          {{ $t("present_working_here") }}
        </span>
      </label>
    </div>
    <div class="hire-professional-budget__buttons">
      <nuxt-link to="/" class="btn-default hire-professional-budget__button">{{
        $t("skip_now")
      }}</nuxt-link>
      <div
