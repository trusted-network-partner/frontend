      ...
      >
        ...
        <div class="calendar-info__users">
          ...
          >
            <nuxt-link
              to="agent-info"
              class="calendar-info__user"
            >
              <img
                :src="require(`~/assets/img/calendar/${user.img}`)"
                alt=""
              >
            </nuxt-link>
          </div>
  ...
  export default {
    ...
    data() {
      return {
        tasks: {
          hold: [
            { id: 0, title: 'Visit with belgium customers.', status: 'pending', priority: 'minor',
              users: [
                { id: 0, img: 'pic1.png'},
                { id: 1, img: 'pic2.png'},
                { id: 2, img: 'pic3.jpg'},
            ...
            { id: 1, title: 'Share documents with the  team.', status: '', priority: 'normal',
              users: [
                { id: 0, img: 'pic1.png'},
                { id: 1, img: 'pic2.png'},
                { id: 2, img: 'pic3.jpg'},
            ...
            { id: 2, title: 'Appointment with the buyer.', status: 'pending', priority: 'critical',
              users: [
                { id: 0, img: 'pic1.png'},
                { id: 1, img: 'pic2.png'},
                { id: 2, img: 'pic3.jpg'},
            ...
            { id: 3, title: 'Negotiation with the seller', status: 'pending', priority: 'minor',
              users: [
                { id: 0, img: 'pic1.png'},
              ]
            }
          ...
          completed: [
            { id: 0, title: 'Appointment with the buyer.', status: 'pending', priority: 'critical',
              users: [
                { id: 0, img: 'pic1.png'},
                { id: 1, img: 'pic2.png'},
                { id: 2, img: 'pic3.jpg'},
            ...
            { id: 1, title: 'Negotiation with the seller', status: 'pending', priority: 'minor',
              users: [
                { id: 0, img: 'pic1.png'},
              ]
            },
