<template>
  <div class="estate-info__item">
    ...
    <div class="content-form__items flex">
      ...
      >
        <div
          class="info-default info-default__items select-width select-inside"
        >
          <div class="info-default__item flex">
            <div class="info-default__element" :class="{ period: home.period }">
    ...
    >
      ...
      <transition name="slide-fade">
        <div v-if="isOptionsShown" class="select-dropdown">
          <div
