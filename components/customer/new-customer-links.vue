...
export default {
  ...
  data() {
    return {
      links: [
        { title: 'Type', path: 'customer-type', isPassed: false },
        { title: 'Category', path: 'customer-category', isPassed: false },
        { title: 'Details', path: 'customer-details', isPassed: false },
        { title: 'Documentation', path: 'customer-documentation', isPassed: false },
      ],
    }
  },
